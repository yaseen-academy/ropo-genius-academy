...
export const DICT = {
  en: {
    ...
    continue: "Continue",
    skip: "Skip",
    gatesTitle: "Sign in to continue",
    gatesBody: "Enter your name and email once — this device will be remembered after that.",
  ...
  ar: {
    ...
    continue: "استمرار",
    skip: "تخطي",
    gatesTitle: "سجل دخولك عشان تكمل",
    gatesBody: "اكتب اسمك وإيميلك مرة واحدة بس — الجهاز ده مش هيسألك تاني بعد كده.",
    yourEmail: "إيميلك",
